...
Command.prototype.do = function(fn){
  this.robot.on(this.event, this.regex, fn);
  return this;
}

/**
 * Set the command's summary.
 *
 * @param {String} summary
 * @return {Command}
 */

Command.prototype.summary = function(summary){
  this.summary = summary;
  return this;
}

/**
 * Add mention and hear event handler functions.
 */

function addEventHandler(event){
  Command.prototype[event] = function(str){
    this.event = event;
    this.usage(str);
    return this;
  }
...
var events = [ 'mention', 'hear' ];

for (var i = 0; i < events.length; i++){
  addEventHandler(events[i]);
}
...
Robot.prototype.command = function(name){
  // need to pass in robot here or add this command to a list
